...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (changePhotoBtn && photoUploadInput && profileImage) {
    ...
    photoUploadInput.addEventListener("change", function () {
      ...
      // Remove token logic: do not append token to formData
      ...
      fetch("../api/users/upload-avatar.php", {
        ...
        .then(data => {
          if (data.success && data.avatar_url) {
            ...
            // Store new avatar URL in localStorage and trigger storage event
            localStorage.setItem('userProfileAvatar', data.avatar_url);
            window.dispatchEvent(new StorageEvent('storage', { key: 'userProfileAvatar', newValue: data.avatar_url }));
