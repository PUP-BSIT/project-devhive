...
file_put_contents(__DIR__ . '/../../../share.log', "Incoming: " . date('c') . " " . file_get_contents('php://input') . "\n", FILE_APPEND);
...
try {
    ...
    // Log parsed data
    file_put_contents(__DIR__ . '/../../../share.log', "Parsed: post_id=$post_id, user_id=$user_id, platform=$platform, caption=$caption\n", FILE_APPEND);
    ...
    file_put_contents(__DIR__ . '/../../../share.log', "Error: " . date('c') . " " . $e->getMessage() . "\n", FILE_APPEND);
    echo json_encode([
        'status' => 'error',
