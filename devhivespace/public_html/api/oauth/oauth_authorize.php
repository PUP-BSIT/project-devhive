...
// Move the logout handler here, right after session_start and before any output
...
<head>
  ...
  <link rel="stylesheet" href="./authorize_form.css" />
</head>
<body>
...
<body class="devhive-bg">
    <div class="card-container">
        <div class="card">
            ...
            <p class="card-desc">
                The application <strong><?= htmlspecialchars($client_id) ?></strong> is requesting permission to access your account.
            </p>
            <form method="post">
                <input type="hidden" name="client_id" value="<?= htmlspecialchars($client_id) ?>">
                <input type="hidden" name="redirect_uri" value="<?= htmlspecialchars($redirect_uri) ?>">
