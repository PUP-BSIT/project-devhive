...
// Always require session_config.php FIRST!
require_once __DIR__ . '/../../../config/session_config.php';
// This will register your custom handler and call session_start() via initializeSession()

initializeSession(); // Use your helper, not session_start() directly
...
if ($stmt->num_rows === 0) {
    ...
    if ($stmt->execute()) {
        error_log("Token successfully inserted for user_id: $user_id");
    } else {
